...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_split_3x5_3(
    ...
    SHFT_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_N,    KC_M, KC_COMM,  KC_DOT, SHIFT_SLASH,
                       MO(1),KC_LGUI, RASE_ENT,       RASE_BACK, LOWER_SPC, KC_TAB
    ),
  [1] = LAYOUT_split_3x5_3(
    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,           KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
    KC_ESC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,            KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, KC_QUOT,
    KC_LSFT, KC_GRV, KC_TRNS, KC_TRNS, XXXXXXX,           KC_MINS,  KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS,
  ...
  [2] = LAYOUT_split_3x5_3(
    ...
    KC_ESC,   KC_TILD, KC_TRNS, KC_TRNS, KC_TRNS,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
                            _______,  KC_LGUI,  KC_ENT,         KC_BSPC,  KC_SPC, _______
                          ),
